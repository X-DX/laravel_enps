...
| M4 — Subscriber & Account | [4a list](M4-4a-subscriber-list.md) · [4b detail](M4-4b-subscriber-detail.md) · [4c issue](M4-4c-issue-account.md) · [4d finalize](M4-4d-finalize-account.md) | 🟡 in progress (4a–4d: list · detail · issue form · finalize+allot account no via a safe per-dept counter in a Service class — 131 tests) |
