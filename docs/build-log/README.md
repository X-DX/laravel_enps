...
| M5 — PRAN & Letters | [5.1 assign PRAN](M5-5.1-assign-pran.md) | 🟡 in progress (5.1 Assign PRAN: search account → add/update PRAN draft (12-digit, confirm-match, globally unique) → pending list with select-all + Finalize/Delete/Excel/PDF — 159 tests) · Part 2 Letters pending |
